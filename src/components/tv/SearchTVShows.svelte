<script>
	import { getTVShows, tvShows, tvShowPageStore, totalTVShowPagesStore, loadMoreTVShows } from '$lib/api/tvShows.js';
...
<div class="page-header-container">
	...
	<div class="input-and-button">
		<input type="text" bind:value={searchQuery} placeholder="Search for a TV show..." on:keydown={handleKeyPress} />
